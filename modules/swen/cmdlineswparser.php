...
#EOF
$cxn = mysql_connect('localhost:/Applications/xampp/xamppfiles/var/mysql/mysql.sock', 'root', '');
$db = mysql_selectdb('kamusi2', $cxn) or die(mysql_error());
    $result = mysql_query($stmt, $cxn) or die(mysql_error());
    if (!$result) {
